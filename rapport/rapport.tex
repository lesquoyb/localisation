...
\item[Quatrième test] Il n' a pas de décalage de phase. Ce qui est consistant avec le fait que les deux micro recoivent la meme chose, meme si l'un des deux est unidirectionnel.
\item[Cinquième test] Le signal enregistré par le micro entouré d'un cone est beaucoup plus faible que celui sans. De plus, les deux signaux ne se ressemble pas beaucoup, il est donc difficile de répérer des extremums qui coincident.
\end{description}
...
Nous incluons des capture d'écran des signaux quand ils sont pertinant à l'explication. 
...
On remarque qu'il y a 2 signaux, ce sont les deux pistes de l'enregistrement audio. Celle du haut correspond au canal gauche, et celle du bas au canal droit. Souvant, la zone selectionné indique une partie du signal qui est important (décalage de phase notable, difference dans les deux signaux, etc...).
